-- Refresh default campaign templates with ICP-specific consultative copy.

update public.system_templates
set category = 'MEI consultivo',
...
where template_type = 'campaign'
  and title = 'Migração para plano empresarial';

update public.system_templates
set category = 'Reajuste',
    ...
    updated_at = now()
where template_type = 'campaign'
  and title = 'Plano de saúde para MEI';

update public.system_templates
set category = 'Rede hospitalar',
    ...
    updated_at = now()
where template_type = 'campaign'
  and title = 'Plano empresarial para pequenas empresas';

update public.system_templates
set category = 'Pequena equipe',
    ...
    updated_at = now()
where template_type = 'campaign'
  and title = 'Comparativo entre operadoras';

update public.system_templates
set title = 'Inclusão de sócios, dependentes e pró-labore',
    ...
    updated_at = now()
where template_type = 'campaign'
  and title = 'Inclusão de sócios e equipe';

update public.system_templates
set category = 'Primeira contratação',
    ...
    updated_at = now()
where template_type = 'campaign'
  and title = 'Revisão de contrato atual';

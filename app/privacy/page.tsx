...
export const metadata = buildLegalMetadata({
  ...
  pathname: "/privacy",
  description:
    "Politica publica de privacidade do Leadi para operacao do CRM, integracoes Meta, IA, pagamentos e suporte."
});
...
const sections = [
  {
    title: "1. Escopo",
    body: [
      "O Leadi e uma plataforma SaaS voltada para captacao, organizacao e acompanhamento de leads comerciais no contexto de planos de saude empresariais. Esta politica descreve como dados pessoais e dados operacionais podem ser tratados durante o uso do produto.",
  ...
  },
  {
    ...
    body: [
      "A plataforma pode armazenar dados enviados diretamente por usuarios do Leadi ou por integracoes autorizadas, incluindo nome, telefone, email, empresa, cidade, interesses comerciais, historico de contato, payloads tecnicos de webhook e identificadores de campanha ou formulario.",
  ...
  },
  {
    ...
    body: [
      ...
      "O Leadi pode integrar servicos como Supabase para banco e autenticacao, provedores de IA para geracao assistida, plataformas de pagamento e conectores de marketing ou automacao, como Meta Lead Ads, Make ou Zapier. Esses compartilhamentos ocorrem apenas na medida necessaria para executar o produto e suas integracoes."
    ]
  },
  {
    title: "5. Retencao, seguranca e transferencias",
    body: [
      "O Leadi adota medidas tecnicas e organizacionais razoaveis para reduzir risco de acesso indevido, alteracao, perda ou divulgacao nao autorizada de dados. Isso pode incluir segregacao por organizacao, controles de acesso por perfil, logs e protecao de credenciais.",
      ...
      "Parte do processamento pode envolver fornecedores com infraestrutura fora do Brasil. Nesses casos, o Leadi busca adotar salvaguardas contratuais e tecnicas compativeis com a natureza do servico."
    ]
  },
  {
    title: "6. Direitos, exclusao e contato",
    body: [
      "Solicitacoes sobre dados, revisoes cadastrais, exclusao, exportacao ou esclarecimentos de privacidade podem ser encaminhadas pelos canais oficiais do Leadi informados neste dominio ou no relacionamento comercial.",
...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      eyebrow="Privacidade"
      sections={[...sections]}
      summary="Como o Leadi pode tratar dados de leads, equipes, campanhas, pagamentos e integracoes durante a operacao do CRM."
      title="Politica de Privacidade"
    />
  );
}

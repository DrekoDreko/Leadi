  ...
  const steps: Step[] = [
    {
      ...
      previewContent: (
        <div className="space-y-4 animate-fade-in">
          <div className="rounded-[18px] bg-cobalt/5 p-4 border border-cobalt/10">
    ...
    },
    {
      ...
      previewContent: (
        <div className="space-y-3 animate-fade-in">
          <div className="rounded-[20px] bg-emerald-50 border border-emerald-200/60 p-4">
          ...
          <div className="rounded-[22px] border border-[#d2d2d7] bg-white dark:bg-white/5 p-4 shadow-soft max-w-[290px] mx-auto">
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-ink/40">Patrocinado</p>
              </div>
            </div>
            <p className="text-xs text-ink mb-3 leading-snug">
              Compare as melhores opções de planos de saúde de forma rápida e segura.
            </p>
            <div className="rounded-xl overflow-hidden border border-ink/8 bg-neutral-100 aspect-[4/3] flex items-center justify-center relative">
              <span className="text-xs font-medium text-ink/40">Criativo de Saúde PME</span>
            ...
            <div className="mt-3 flex items-center justify-between border-t border-ink/6 pt-3">
              ...
              <span className="rounded bg-cobalt px-3 py-1.5 text-[11px] font-bold text-white uppercase tracking-wider">
                Cadastrar-se
              </span>
            </div>
          </div>
          ...
          <div className="rounded-[22px] border border-ink/8 bg-white dark:bg-white/5 p-5 shadow-soft">
            ...
            <div className="space-y-2.5 text-sm">
              <div className="flex justify-between">
                <span className="text-ink/50">Responsável:</span>
              ...
              <div className="flex justify-between">
                <span className="text-ink/50">Telefone:</span>
      ...
      previewContent: (
        <div className="space-y-4 animate-fade-in">
          <div className="rounded-[22px] bg-white dark:bg-white/5 border border-ink/8 p-5 shadow-soft">
            ...
            <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-4 relative text-sm text-ink leading-relaxed">
              <p>
